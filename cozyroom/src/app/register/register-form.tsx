...
function SubmitButton() {
  ...
  return (
    <button 
      type="submit" 
      disabled={pending}
      className="inline-flex w-full items-center justify-center rounded-xl bg-linear-to-r from-emerald-500 to-teal-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-emerald-500/40 transition hover:from-emerald-400 hover:to-teal-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:cursor-not-allowed disabled:opacity-60"
    >
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-950 to-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center space-y-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-400">
              Join CozyRoom and start your cozy journey.
            </p>
          </div>
        </div>
        ...
        >
          {state?.error && (
            <div
              className={`flex items-start gap-2 rounded-xl border px-3.5 py-2.5 text-sm shadow-sm ${
                state.requiresConfirmation
                  ? 'border-blue-500/40 bg-blue-950/60 text-blue-100 shadow-blue-900/60'
                  : 'border-red-500/40 bg-red-950/60 text-red-100 shadow-red-900/60'
              }`}
              role="alert"
            >
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="mt-0.5 w-full rounded-xl border border-slate-700/80 bg-slate-900/70 px-3.5 py-2.5 text-sm text-slate-100 placeholder:text-slate-500 shadow-sm shadow-black/40 outline-none transition focus:border-emerald-400/80 focus:ring-2 focus:ring-emerald-500/70"
            />
          </div>
